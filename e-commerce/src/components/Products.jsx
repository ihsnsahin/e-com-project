    ...
    return (
        <div className="flex flex-col gap-[48px] md:max-w-5xl md:m-auto">
            <div className="flex flex-col items-center justify-center gap-2.5">
                ...
                <h3 className="text-2xl text-center w-3xs">BESTSELLER PRODUCTS</h3>
                <p className="text-sm text-[#737373] text-center w-3xs font-normal">Problems trying to resolve the conflict between</p>
            </div>
