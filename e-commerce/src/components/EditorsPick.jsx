function EditorsPick() {
    return (
        <section className="bg-[#FAFAFA] px-9 py-20 lg:px-0">
            <div className="flex flex-col gap-[3rem] md:max-w-5xl md:m-auto">
                ...
                <div className="flex flex-col md:flex-row gap-[30px] md:h-[500px]">
                    <div className="relative md:flex-[2] h-[500px] md:h-full">
                        <img src="/edit1.jpg" alt="men" className="w-full h-full object-cover" />
